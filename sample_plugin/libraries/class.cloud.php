...
class SampleCloudOwnMethod extends ErrorReporting
{
     ...
     */
    public function getSampleCloudUserInfo()
    {
    ...
    public function getConnectedInformation()
    {
        ...
        try {
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name getConnectedInformation', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function deleteSampleCloudMedia($media_id = NULL)
    {
        try {
            if (!empty($media_id)) {
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name deleteSampleCloudMedia', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function getSampleCloudPlayer()
    {
        try {
            $result = array();
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name getSampleCloudPlayer', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function getSampleCloudChannels()
    {
        try {
            return array(
                'news' => 'News &amp; Politics',
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name getSampleCloudChannels', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function getSampleCloudVideos($page_no = 1, $per_page = 10, $search_title = '', $filter = '-created')
    {
        $result = array();
        try {
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name getSampleCloudVideos', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function getSampleCloudVideosDetails($media_id = null)
    {
        $result = array();
        try {
            if (!empty($media_id)) {
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name getSampleCloudVideosDetails', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function getSampleCloudVideosKeywords($media_id = null)
    {
        try {
            if (!empty($media_id)) {
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name getSampleCloudVideosKeywords', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function setSampleCloudVideoMetas($media_id = null, $args = array())
    {
        try {
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name setSampleCloudVideoMetas', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function removeSampleCloudVideoMetas($media_id = null, $args = array())
    {
        try {
            if (!empty($media_id) && !empty($args)) {
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name removeSampleCloudVideoMetas', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function setSampleCloudVideoThumbnail($media_id = null, $url = NULL)
    {
        try {
            ...
            $this->log_error($e->getMessage() . ' in class.cloud.php function name setSampleCloudVideoThumbnail', 'phparray', $e->getLine(), $e->getFile());
        }
    }
     ...
     * Method to update sample video
     */
    public function uploadSampleCloudVideo($video_url = null, $file_name = null)
    {
     ...
     */
    public function createNewUserOnOrganigation($user_id = null, $user_login = null, $email_id = null)
    {
      try {
        ...
        $error = $this->log_error($e->getMessage(),
                                  'phparray',
                                  $e->getLine(),
                                  $e->getFile());
        return $error;
